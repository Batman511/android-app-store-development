...
//Инициализация списка установленных приложений
public class AppAdapter extends ArrayAdapter<ApplicationInfo>{

    private List<ApplicationInfo> appList = null; //объявление списка
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(null == view) {
            LayoutInflater layoutInflater = (LayoutInflater) context
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE); //наполнение макета
